function Socials(){
    const socialLinks = {
      ...
      const handleSocialClick = (social:string )=>{
        if (social === "email"){
          ...
          window.location.href = socialLinks.insta
    ...
    return (<>
              <div className="socials__button">
                <div onClick={()=>{handleSocialClick("email")}} className="socials__button__media" id="email"><svg className="button__icon" fill="#FFFFFF"
                ...
                <div onClick={()=>{handleSocialClick("insta")}} className="socials__button__media" id="insta">
                ...
                <div onClick={()=>{handleSocialClick("linkedin")}} className="socials__button__media" id="linkedin"><svg className="button__icon" viewBox="0 0 24 24"
